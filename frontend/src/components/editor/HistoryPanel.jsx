...
export default function HistoryPanel({ docId, onRestored }) {
  ...
  return (
    <div className="w-[380px] border-l border-border-d bg-overlay p-3 flex flex-col">
      ...
      <pre className="mt-1 flex-1 overflow-auto text-xs text-amd-white/70 bg-surface rounded p-2 whitespace-pre-wrap">
